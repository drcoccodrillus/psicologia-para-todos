...
CREATE TABLE `tests_results` (
  ...
  `t_risk` decimal(10,0) DEFAULT NULL,
  `anxiety_risk` decimal(10,0) DEFAULT NULL,
  `depression_risk` decimal(10,0) DEFAULT NULL,
  `panic_risk` decimal(10,0) DEFAULT NULL,
  `rage_risk` decimal(10,0) DEFAULT NULL,
  `mes_risk` decimal(10,0) DEFAULT NULL,
  `style_risk` decimal(10,0) DEFAULT NULL,
